...
import { WORKSPACE_CONFIG_AUTOSAVE_DELAY_MS, type WorkspaceConfigMutationCommand } from '../types';
...
export class ConfigSaveQueue {
  ...
  enqueue(context: SaveContext, commands: readonly WorkspaceBufferedMutationCommand[]): void {
