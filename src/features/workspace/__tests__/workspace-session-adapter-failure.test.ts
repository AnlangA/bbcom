...
import { SessionStoreWorkspaceAdapter } from '@/features/workspace/session-store-workspace-adapter.ts';
import type { WorkspaceApplicationService } from '@/features/workspace/application/index.ts';
