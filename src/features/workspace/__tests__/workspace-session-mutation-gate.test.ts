...
} from '@/features/sessions/store/session-store.ts';
import { createSessionCaptureController } from '@/features/sessions/capture/session-capture-controller.ts';
import { createSessionRecord } from '@/lib/session-persistence.ts';
import type { PortConfig } from '@/types/index.ts';
import type { HydratedWorkspaceSession } from '@/features/workspace/adapters/index.ts';
