...
import AiLogAssistant from '@/features/ai/ui/AiLogAssistant.vue';
import AiTerminalAssistant from '@/features/send-panel/ui/AiTerminalAssistant.vue';
import type { AiWindowSession } from '@/types/ai.ts';
...
vi.mock('@/features/settings/store/app-store', () => ({ useAppStore: () => ui.app }));
vi.mock('@/lib/logger', () => ({
