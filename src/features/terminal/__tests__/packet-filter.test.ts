...
import { formatHex, formatUtf8 } from '@/lib/format.ts';
import {
  hexChunksInclude,
  textChunksInclude,
  usePacketFilter,
} from '@/features/terminal/application/use-packet-filter.ts';
import { MAX_MERGED_VISIBLE_BYTES } from '@/lib/merged-frame-rope.ts';
import type { DataFrame, PacketViewMode, SearchMode } from '@/types/index.ts';
