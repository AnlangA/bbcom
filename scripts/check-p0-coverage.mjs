...
const P0_DOMAINS = Object.freeze({
  ...
  'session-runtime': [
    ...
    'src/features/sessions/runtime/session-residency.ts',
    'src/features/sessions/runtime/session-runtime-controller.ts',
    'src/features/sessions/runtime/session-runtime-manager.ts',
    ...
    'src/lib/serial-port-adapter.ts',
